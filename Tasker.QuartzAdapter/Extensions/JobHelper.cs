...
namespace Tasker.QuartzAdapter.Extensions
{
    ...
    public static class JobHelper
    {
            ...
            where T : ITask
        {
            ...
            var codeMemberMethod = CreateMethod();
        ...
        private static CodeMemberMethod CreateMethod()
        {
            ...
            codeMemberMethod.Parameters.Add(new CodeParameterDeclarationExpression(typeof(IJobExecutionContext),
                "context"));
